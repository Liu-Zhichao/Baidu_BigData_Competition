...
if __name__=="__main__":
    ...
    parser.add_argument('--input_file', type=str, default='data/data_processed/region_migration.csv')
    parser.add_argument('--label_file', type=str, default='data/data_processed/infection.csv')
    parser.add_argument('--adj_mat_file', type=str, default='data/data_processed/adj_matrix.npy')
    parser.add_argument('--region_names_file', type=str, default='data/data_processed/region_names.txt')
